'use strict';
/* ============================================================
   MAULI SPA V2 — COMPLETE JAVASCRIPT (Upgraded & Optimized)
   ============================================================ */
...
const THERAPY_EN={
  ...
  thAroma:"Aromatherapy Massage",thAromaPrice:"₹2,299",thAromaDur:"60 mins",
  thAromaShort:"Relaxing massage using pure, therapeutic essential oils.",
  thAromaLong:"Combines soft, relaxing massage techniques with the healing power of essential oils extracted from plants.",
  thAromaP1:"Skin hydration",thAromaP2:"Lymphatic boost",thAromaP3:"Gentle detox",thAromaP4:"Immune support",
  thAromaM1:"Mood elevation",thAromaM2:"Stress relief",thAromaM3:"Mental clarity",thAromaFor:"Those seeking emotional balance and stress relief.",
...
const THERAPY_HI={
  ...
  thAroma:"एरोमाथेरेपी मसाज",thAromaPrice:"₹2,299",thAromaDur:"60 मिनट",
  thAromaShort:"शुद्ध आवश्यक तेलों (essential oils) के साथ आरामदेह मालिश।",
  thAromaLong:"पौधों से निकाले गए आवश्यक तेलों की उपचार शक्ति के साथ नरम, आरामदेह मालिश।",
  thAromaP1:"त्वचा हाइड्रेशन",thAromaP2:"लिम्फैटिक बूस्ट",thAromaP3:"सौम्य डिटॉक्स",thAromaP4:"इम्यून सपोर्ट",
  thAromaM1:"मूड बेहतर",thAromaM2:"तनाव से राहत",thAromaM3:"मानसिक स्पष्टता",thAromaFor:"भावनात्मक संतुलन और तनाव राहत चाहने वाले।",
...
const THERAPY_MR={
  ...
  thSpaPackM1:"संपूर्ण विश्रांती",thSpaPackM2:"तनावपासून मुक्ती",thSpaPackM3:"मनाची ताजेपणा",thSpaPackFor:"संपूर्ण rejuvenation इच्छिणाऱ्यांसाठी.",
  
  thAroma:"अरोमाथेरपी मसाज",thAromaPrice:"₹2,299",thAromaDur:"60 मिनिटे",
  thAromaShort:"अत्यावश्यक तेलांसह (essential oils) आरामदायी मालिश.",
  thAromaLong:"वनस्पतींमधून काढलेल्या तेलांच्या उपचार शक्तीसह मऊ, आरामदायी मालिश.",
  thAromaP1:"त्वचा हायड्रेशन",thAromaP2:"लिम्फॅटिक बूस्ट",thAromaP3:"सौम्य डिटॉक्स",thAromaP4:"रोगप्रतिकारक आधार",
  thAromaM1:"मूड सुधारतो",thAromaM2:"तणावमुक्ती",thAromaM3:"मानसिक स्पष्टता",thAromaFor:"भावनिक संतुलन शोधत असलेले.",
  ...
  thCreamM1:"Pampered feeling",thCreamM2:"तनाव दूर",thCreamM3:"Luxury अनुभव",thCreamFor:"Dry skin treatment सोबत relaxation इच्छिणाऱ्यांसाठी.",
...
const THERAPIES=[
  ...
  {id:'aroma',nameKey:'thAroma',priceKey:'thAromaPrice',durKey:'thAromaDur',shortKey:'thAromaShort',longKey:'thAromaLong',physKeys:['thAromaP1','thAromaP2','thAromaP3','thAromaP4'],mentKeys:['thAromaM1','thAromaM2','thAromaM3'],forWhomKey:'thAromaFor',videoSrc:'https://www.w3schools.com/html/mov_bbb.mp4',imgs:["https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=600&h=400&fit=crop","https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=400&fit=crop","https://images.unsplash.com/photo-1507652313519-d4e9174996dd?w=600&h=400&fit=crop"]},
...
/* ── THERAPY CARDS (stroke video lazy load on hover) ── */
  ...
  grid.innerHTML=THERAPIES.map((th,i)=>{
    ...
    <div class="tc" tabindex="0" aria-label="${name}">
      <div class="tc-media">
        ...
        <video class="tc-stroke-video" muted loop playsinline data-src="${th.videoSrc}"></video>
...
function submitContactForm(){
  ...
  const waMsg=encodeURIComponent(`Namaskar Mauli Spa team! 🙏\n\nMera naam ${name} hai aur main aapse contact kar raha/rahi hoon. Mujhe aapki wellness therapies ke baare mein janna tha.\n\n✨ Meri details:\n📞 Phone: ${phone}\n💆 Service: ${service||'Main abhi sure nahi hoon, mujhe suggestion chahiye'}\n📅 Date: ${date||'Flexible'}\n⏰ Time: ${time}\n\n💬 Ek choti si baat: ${msg||'Koi special requirement nahi hai, bas relax karna hai.'}\n\nKripya mujhe guide karein. Dhanyawad! 🌿`);
